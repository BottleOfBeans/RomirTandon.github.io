...
(function starfield3D() {
  ...
  const P = {
    DENSITY: 0.0075,     // stars per CSS pixel
    ...
    STREAK_BASE: 0.35,    // baseline streakiness (0..1+)
  ...
  function warpParams(tRaw){
    ...
    return {
      speedMul: 1 + t * 10.0,        // up to ~8x speed at bottom
      fovMul:   1 + t * 0.40,       // widen FOV slightly during warp
      streakMul:1 + t * 0.40,       // longer trails in warp
